...
in_folder = '/home/kparasch/Storage/Decohered_STL_data/'
out_folder = '/home/kparasch/Storage/processed_Decohered_STL_data/'
filelist10 = ['losses_sixtracklib.4271153.0.h5']
for ii in range(2,12):
     filelist10.append(f'losses_sixtracklib.4271153.{ii}.h5')
filelist20 = []
for ii in range(0,6):
    filelist20.append(f'losses_sixtracklib.4295944.{ii}.h5')
for ii in range(0,11):
    filelist20.append(f'losses_sixtracklib.4328392.{ii}.h5')
for ii in range(0,12):
    filelist20.append(f'losses_sixtracklib.4591293.{ii}.h5')
filelist15 = []
filelist15.append(f'losses_sixtracklib.4351523.0.h5')
filelist15.append(f'losses_sixtracklib.4351523.1.h5')
filelist15.append(f'losses_sixtracklib.4351523.2.h5')
filelist15.append(f'losses_sixtracklib.4351523.4.h5')
filelist15.append(f'losses_sixtracklib.4351523.5.h5')
for ii in range(0,12):
    filelist15.append(f'losses_sixtracklib.4395210.{ii}.h5')
filelist05 = []
for ii in range(0,12):
    filelist05.append(f'losses_sixtracklib.4448724.{ii}.h5')
filelist00 = []
for ii in range(0,8):
    filelist00.append(f'losses_sixtracklib.4487357.{ii}.h5')
