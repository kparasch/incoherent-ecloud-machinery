...
parser.add_argument('--DA_r_N', nargs='?', default=115, type=int)
parser.add_argument('--DA_theta_N', nargs='?', default=11, type=int)
...
parser.add_argument('--mbb', nargs='?', default=None, type=str)
