...
#myhome=/home/kparasch/workspace/incoherent-ecloud-machinery
#source $myhome/miniconda3/bin/activate ""
#export PYTHONPATH=$myhome/PyFRIENDS:$PYTHONPATH
#export PYTHONPATH=$myhome/Tools:$PYTHONPATH

cd $1

time python prepare_pinch.py $1 $2 $3 $4 $5
