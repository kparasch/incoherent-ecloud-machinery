...
for ii in 7
do
    ./do_the_pinch.sh --pinch_name=LHC_MQF_450GeV_sey1.30_${intensity}e11ppb_400npinches_${ii} --states=${states_folder}/injection_ArcQuad_MQF_intensity_${intensity}e11ppb_sey_1.30_VRF_8MV_${ii} --nPinches=400 --intensity=${intensity}
done
